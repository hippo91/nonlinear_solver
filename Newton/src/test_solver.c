...
int main() {
	...
	if (!check_uniform_array_value(pressure, pb_size, "pressure", 10.e+09)) success = false;
	if (!check_uniform_array_value(internal_energy, pb_size, "internal_energy", 1.325e+04)) success = false;
	if (!check_uniform_array_value(solution, pb_size, "solution", 200765.8953965593)) success = false;
	if (!check_uniform_array_value(new_pressure, pb_size, "new_pressure", 13088079183.59054)) success = false;
	if (!check_uniform_array_value(new_cson, pb_size, "new_cson", 4503.84710590959)) success = false;
